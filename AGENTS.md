...
2. Se a variável de ambiente `ATOMIC_REPOSITORY` estiver definida, considere seu valor como o caminho completo do repositório de desenvolvimento. Caso contrário, explore `..` ou `../..` até localizar a raiz do projeto.
